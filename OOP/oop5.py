...
member_one = Member("Amira", "Mustafa", "HM", "Female")
member_two = Member("Ahmed", "Hag", "Imam", "Male")
member_three = Member("Sara", "HI", "Mustafa", "Female")
member_four = Member("shit", "gg", "mm", "ddss")
