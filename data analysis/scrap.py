...
browser.find_element_by_id("search").send_keys("Front-End Developer")
...
views_count = browser.find_element_by_css_selector(".page-info :last-of-type span:last-child")
